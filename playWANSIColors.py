...
print("\n\u001b[32;45;4;1;mLet's explore the ANSI colors.\u001b[0m: \n\n")
response = input("Sound good? (y/n)")
if (response != "y"):
    print("Exiting...")
    sys.exit(0)
...
response = input("\n\u001b[1mWould you like to see the 256 colors? (y/n)\u001b[0m")
if (response == "y"):
    print("\n\u001b[1m256 colors\u001b[0m: \n\n")
    for i in range(256):
...
response = input("\n\u001b[1mWould you like to see the 24-bit RGB colors? (y/n)\u001b[0m")
if (response == "y"):
...
response = input("\n\u001b[1mWould you like to see the 256 colors with background? (y/n)\u001b[0m")
if (response == "y"):
...
response = input("\n\u001b[1mWould you like to see the 24-bit RGB colors with background? (y/n)\u001b[0m")
if (response == "y"):
